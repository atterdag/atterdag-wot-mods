 ...
 */
{
  ...
  "colors": {
    ...
    "winrate": [
      { "value":  45.49,  "color": ${"def.wotlabsColorRating.beginner"      } },   //  0% - 45% - very bad
      { "value":  46.49,  "color": ${"def.wotlabsColorRating.basic"         } },   // 45% - 46% - bad
      { "value":  47.49,  "color": ${"def.wotlabsColorRating.below_average" } },   // 47% - 47% - below average
      { "value":  49.49,  "color": ${"def.wotlabsColorRating.average"       } },   // 48% - 49% - average
      { "value":  51.49,  "color": ${"def.wotlabsColorRating.above_average" } },   // 50% - 51% - above average
      { "value":  53.49,  "color": ${"def.wotlabsColorRating.good"          } },   // 52% - 53% - good
      { "value":  55.49,  "color": ${"def.wotlabsColorRating.very_good"     } },   // 54% - 55% - very good
      { "value":  59.49,  "color": ${"def.wotlabsColorRating.great"         } },   // 56% - 59% - great
